...
public interface DHESOAPWebService {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "addLearner", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.AddLearner")
    @ResponseWrapper(localName = "addLearnerResponse", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.AddLearnerResponse")
     ...
     * @param id
     * @return
     *     returns za.org.dhe.jws.Learner
     * @throws Exception_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getLearner", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.GetLearner")
    @ResponseWrapper(localName = "getLearnerResponse", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.GetLearnerResponse")
     ...
     * 
     * @return
     *     returns java.util.List<za.org.dhe.jws.Learner>
     * @throws Exception_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getLearners", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.GetLearners")
    @ResponseWrapper(localName = "getLearnersResponse", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.GetLearnersResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "deleteLearner", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.DeleteLearner")
    @ResponseWrapper(localName = "deleteLearnerResponse", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.DeleteLearnerResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "updateLearner", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.UpdateLearner")
    @ResponseWrapper(localName = "updateLearnerResponse", targetNamespace = "http://jws.dhe.org.za/", className = "za.org.dhe.jws.UpdateLearnerResponse")
